//recover - db is queried with email to retrieve user obj. if found, generatepasswordreset is called
//reset - queries db for user obj using pw reset token and verifies if its still valid
//reset pw - queries db using reset token and verifies if its still valid. if valid, users pw is updated.
...
// @access Public
exports.recover_post = async (req, res) => {
  try {
