//update - user id is extracted and update obj created that is used to query and update user's data
...
//update user details
//@access public
exports.user_update_put = async function (req, res) {
  try {
...
//Delete user
//@access Public
exports.user_destroy = async function (req, res) {
  try {
    const id = req.params.id;
